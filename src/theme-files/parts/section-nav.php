            ...
            <div class="d-flex">
                <a href="javascript:void(0)" id="close-slidenav">
                    <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.68637 1.41421C2.46742 0.633165 3.73375 0.633165 4.5148 1.41421L24.3138 21.2132C25.0948 21.9943 25.0948 23.2606 24.3138 24.0416C23.5327 24.8227 22.2664 24.8227 21.4854 24.0416L1.68637 4.24264C0.905324 3.46159 0.905324 2.19526 1.68637 1.41421Z" fill="#3498DB" />
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.68619 24.0417C0.905138 23.2606 0.905138 21.9943 1.68619 21.2132L21.4852 1.41424C22.2662 0.633189 23.5326 0.63319 24.3136 1.41424C25.0947 2.19529 25.0947 3.46162 24.3136 4.24267L4.51461 24.0417C3.73356 24.8227 2.46723 24.8227 1.68619 24.0417Z" fill="#3498DB" />
                    </svg>
                </a>
                <div class="text-secondary fs-36 fw-700 text-uppercase px-4">Menu</div>
            </div>
    ...
    <div class="navigation">
        <div class="container d-none d-lg-block">
            <div class="row justify-content-between align-items-center py-4">
                ...
                <div class="col-auto">
                    <div class="d-flex align-items-center nav-btns gap-3">
                        <a href="tel:<?= get_field('phone_number', 'options') ?>" class="btn bordered border-dark rounded-pill text-black py-2 px-4 fw-700">
                            <?= get_field('phone_number', 'options') ?>
                        </a>

                        <a href="tel:<?= get_field('mobile_number', 'options') ?>" class="btn bordered border-dark rounded-pill text-black py-2 px-4 fw-700">
